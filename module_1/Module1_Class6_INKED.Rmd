---
title: "Class 1-6: Propensity scores"
...
**Would we say that this relationship between smoking and the risk of disease is significant?**  Yes!  If we look at the p-value associated with the `eversmk` coefficient, we see that it is `0.000182`, which is less that the standard significance level of $\alpha = 0.05$.  This means we would reject the null hypothesis that this coefficient is 0 and conclude there is a relationship between smoking status and disease, after controlling for the propensity for smoking due to age, sex, marital status and education level!
...
5. Submission notes:
    * Submit your assignment in R Markdown through Github by Sunday (February 12, 2023) at midnight. You can find a link to create this assignment in Github on Canvas
