...
* You are encouraged to complete online tutorials on using R through Posit/RStudio Cloud ("Learn" --> "Primers" in the left-hand menu)
...
* **On Mondays:**
    ...
    * We will ask that you turn in your work to us (post on Piazza and pushed to GitHub) by Sunday night at midnight so we can prepare for Monday's class
...
On Wednesday we will talk about incorporating this "otherwise similiar" concept into our graphical displays and spend time working on the first assignment which will be due on Sunday evening.
