...
* Risk of death for singletons: 526/9425 = 0056
...
```{r}
tidy(model2) %>% kable(digits = 3, format = "markdown")
```
...
```{r}
model3 <- glm(death ~ gestage + twins + male, family=binomial(link="logit"), data=nepal_data)
...
* Submit your data display in R Markdown through Github by Sunday (February 5, 2023) at midnight. You can find a link to create this assignment in Github on Canvas.
