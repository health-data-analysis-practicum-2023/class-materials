...
I can't put the code here yet, but take a look at [Anon Calc on Piazza](https://piazza.com/class/ld7tidrzlpp70o/post/30_f9){target="_blank"}. How do you think the variables in the plot are ordered?
...
One of you posted an example of a table comparison on [Piazza](https://piazza.com/class/ld7tidrzlpp70o/post/30_f11){target="_blank"}. What are some things that work well or could be improved with this set of tables?
