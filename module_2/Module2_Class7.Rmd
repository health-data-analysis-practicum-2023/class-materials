...
dlogp <- plot_model(g1, show.values = TRUE, value.offset = .3, title = "Weighted: Hypertension Odds ratio and Signficance per Term", sort.est = TRUE, auto.label=FALSE, axis.title="Odds Ratio", df.method = "wald")
dlogp 

dlogp <- plot_model(g1_noWt, show.values = TRUE, value.offset = .3, title = "Unweighted: Hypertension Odds ratio and Signficance per Term", sort.est = TRUE, auto.label=FALSE, axis.title="Odds Ratio", df.method = "wald")
dlogp 
